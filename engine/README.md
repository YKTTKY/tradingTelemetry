...
| `POST /v1/indicators` | Full-replace indicator list for one `chart_id` (MA ≤3, Volume ≤1, Session VP ≤1, Fixed Range VP ≤4, Anchored VP ≤2); rejects over-limit; persists; returns configs + series |
